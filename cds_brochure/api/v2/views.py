...
from .serializers import BrochuresListSerializer, BrochuresDetailSerializer
...
class BrochuresViewSet(ReadOnlyModelViewSet):
    ...
    def get_serializer_class(self):
        return (
            ...
            if self.action == "list"
            else BrochuresDetailSerializer
        )
    ...
    def get_queryset(self):
        ...
        if self.action == "retrieve":
            return (
                self.queryset.filter(cds__cds_cod=self.kwargs.get("cds__cds_cod"))
                .prefetch_related(
                    Prefetch(
