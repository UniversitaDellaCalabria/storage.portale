...
def cds_website_brochure(request, code, cds_website=None, my_offices=None):
    ...
    breadcrumbs = {reverse('crud_utils:crud_dashboard'): _('Dashboard'),
                   reverse('crud_cds_websites_brochure:crud_cds_websites_brochure'): _('CdS in brief'),
                    '#': cds_website.cds.nome_cds_it if (request.LANGUAGE_CODE == 'it' or not cds_website.cds.nome_cds_eng) else cds_website.cds.nome_cds_eng,
                }
...
def cds_websites_brochure_info_edit(request, code, cds_website=None, my_offices=None):
    ...
    breadcrumbs = {reverse('crud_utils:crud_dashboard'): _('Dashboard'),
                   reverse('crud_cds_websites_brochure:crud_cds_websites_brochure'): _('CdS in brief'),
                   reverse('crud_cds_websites_brochure:crud_cds_website_brochure', kwargs={'code': code} ): cds_website.cds.nome_cds_it if (request.LANGUAGE_CODE == 'it' or not cds_website.cds.nome_cds_eng) else cds_website.cds.nome_cds_eng,
                   '#': _("Info") }
...
def cds_websites_brochure_exstudents_new(request, code, cds_website=None, my_offices=None):
    ...
    breadcrumbs = {reverse('crud_utils:crud_dashboard'): _('Dashboard'),
                   reverse('crud_cds_websites_brochure:crud_cds_websites_brochure'): _('CdS in brief'),
                   reverse('crud_cds_websites_brochure:crud_cds_website', kwargs={'code': code} ): cds_website.cds.nome_cds_it if (request.LANGUAGE_CODE == 'it' or not cds_website.cds.nome_cds_eng) else cds_website.cds.nome_cds_eng,
