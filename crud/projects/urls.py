...
urlpatterns += path('projects/<str:code>/director-data/<str:director_id>/', project_director_edit, name='crud_project_director_edit'),
...
urlpatterns += path('projects/<str:code>/researcher-data/<str:researcher_id>/', project_researcher_edit, name='crud_project_researcher_edit'),
