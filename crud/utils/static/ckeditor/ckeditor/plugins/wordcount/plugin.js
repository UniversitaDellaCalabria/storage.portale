...
CKEDITOR.plugins.add("wordcount",
    {
        ...
        init: function(editor) {
            ...
            var dispatchEvent = function(type, currentLength, maxLength, minLength) {
                ...
                if (maxLength != -1) {
                    eventInitDict['detail']['maxLength'] = maxLength;
                }
                if (minLength != -1) {
                    eventInitDict['detail']['minLength'] = minLength;
                }
            ...
            var defaultConfig = {
                ...
                wordCountGreaterThanMaxLengthEvent: function(currentLength, maxLength) {
                    dispatchEvent("wordCountGreaterThanMaxLengthEvent", currentLength, maxLength, -1);
                },
                charCountGreaterThanMaxLengthEvent: function(currentLength, maxLength) {
                    dispatchEvent("charCountGreaterThanMaxLengthEvent", currentLength, maxLength, -1);
                },

                //Allowed Functions
                wordCountLessThanMaxLengthEvent: function(currentLength, maxLength) {
                    dispatchEvent("wordCountLessThanMaxLengthEvent", currentLength, maxLength, -1);
                },
                charCountLessThanMaxLengthEvent: function(currentLength, maxLength) {
                    dispatchEvent("charCountLessThanMaxLengthEvent", currentLength, maxLength, -1);
                },
            ...
            if (!config.custom) {
                ...
                defaultFormat += "  ";
                if(config.minCharCount > -1 || config.maxCharCount > -1){
                    defaultFormat += '(';
                }
                if(config.minCharCount > -1)  {
                    defaultFormat += "Min: " + config.minCharCount;
                    defaultFormat += " - ";
                }
                if(config.maxCharCount > -1) {
                    defaultFormat += "Max: " + config.maxCharCount;
                }
                if(config.minCharCount > -1 || config.maxCharCount > -1){
                    defaultFormat += ')';
                }
