...
urlpatterns += path('cds/<str:regdid_id>/manifesto-and-regulation/',
                    cds_manifesto_regulation, name='cds_manifesto_regulation'),
...
urlpatterns += path('cds/<str:regdid_id>/study-manifesto/delete/',
                    cds_study_manifesto_delete, name='cds_study_manifesto_delete'),
urlpatterns += path('cds/<str:regdid_id>/didactic-regulation/delete/',
                    cds_didactic_regulation_delete, name='cds_didactic_regulation_delete'),
