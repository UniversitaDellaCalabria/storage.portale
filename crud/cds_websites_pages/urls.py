...
#Reg Artciles
urlpatterns += path('cds-websites-pages/<str:code>/topics/<str:topic_id>/items/regulament-articles/add/', cds_websites_pages_regart_add, name='crud_cds_websites_pages_regart_add'),
urlpatterns += path('cds-websites-pages/<str:code>/topics/<str:topic_id>/items/<str:data_id>/regulament-articles/', cds_websites_pages_regart_item_edit, name='crud_cds_websites_pages_regart_item_edit'),
urlpatterns += path('cds-websites-pages/<str:code>/topics/<str:topic_id>/items/<str:data_id>/regulament-articles/extra/new', cds_websites_pages_regart_extra_new, name='crud_cds_websites_pages_regart_extra_new'),
urlpatterns += path('cds-websites-pages/<str:code>/topics/<str:topic_id>/items/<str:data_id>/regulament-articles/extra/<str:extra_id>/', cds_websites_pages_regart_extra_edit, name='crud_cds_websites_pages_regart_extra_edit'),
urlpatterns += path('cds-websites-pages/<str:code>/topics/<str:topic_id>/items/<str:data_id>/regulament-articles/extra/<str:extra_id>/delete/', cds_websites_pages_regart_extra_delete, name='crud_cds_websites_pages_regart_extra_delete'),
#Objects
