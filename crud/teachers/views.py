...
@can_manage_teachers
@can_edit_teacher
def teacher_detail(request, code, my_offices=None,
                   teacher=None, my_teacher_profile=None):
    """
    pagina dettaglio singolo docente
    """
    # dati docente
    other_data = DocentePtaAltriDati.objects.filter(
        matricola=teacher.matricola).first()

    # bacheca
    board = DocentePtaBacheca.objects.filter(matricola=teacher.matricola)

    # materiale didattico
    materials = DocenteMaterialeDidattico.objects.filter(
        matricola=teacher.matricola)

    logs = LogEntry.objects.filter(content_type_id=ContentType.objects.get_for_model(teacher).pk,
                                   object_id=teacher.pk)

    breadcrumbs = {reverse('crud_utils:crud_dashboard'): _('Dashboard'),
                   reverse('crud_teachers:crud_teachers'): _('Teachers'),
                   '#': teacher}
    ...
    return render(request,
                  ...
                  {'board': board,
                   ...
                   'materials': materials,
                   'teacher': teacher,
                   'url_news': reverse('ricerca:teachernews',
                                       kwargs={'teacherid': m}),
                   'url_books': reverse('ricerca:teachermaterials',
                                        kwargs={'teacherid': m})
                   })
...
@can_manage_teachers
@can_edit_teacher
def teacher_other_data_edit(request,
                            code,
                            data_id,
                            my_offices=None,
                            teacher=None,
    ...
    if request.POST:
        ...
        if form.is_valid():
            ...
            return redirect('crud_teachers:crud_teacher_edit',
                            code=code)
    ...
    breadcrumbs = {
        ...
        reverse('crud_teachers:crud_teachers'): _('Teachers'),
        reverse('crud_teachers:crud_teacher_edit', kwargs={'code': code}): teacher,
        '#': _("Edit data")
    }
...
@can_manage_teachers
@can_edit_teacher
def teacher_other_data_new(request, code, my_offices=None, teacher=None,
                           my_teacher_profile=None):
    """
    nuovo set di dati
    """
    ...
    if request.POST:
        form = DocentePtaAltriDatiForm(data=request.POST,
                                       files=request.FILES)
        ...
        if form.is_valid():
            ...
            return redirect("crud_teachers:crud_teacher_edit", code=code,)
        else:  # pragma: no cover
            for k, v in form.errors.items():
                messages.add_message(request, messages.ERROR,
                                     f"<b>{form.fields[k].label}</b>: {v}")
...
@can_manage_teachers
@can_edit_teacher
def teacher_other_data_delete(request, code, data_id, my_offices=None,
                              teacher=None, materials=None,
...
def teacher_board_data_edit(request, code, data_id,
                            my_offices=None, teacher=None, materials=None,
                            other_data=None, board=None,
                            my_teacher_profile=None):
    """
...
@can_manage_teachers
@can_edit_teacher
def teacher_board_data_new(request, code, my_offices=None, teacher=None,
                           my_teacher_profile=None):
    """
    nuova news bacheca
    """
...
@can_manage_teachers
@can_edit_teacher
def teacher_board_data_delete(request, code, data_id, my_offices=None,
                              teacher=None, my_teacher_profile=None):
    """
...
def teacher_materials_data_edit(request, code, data_id,
                                my_offices=None, teacher=None,
                                my_teacher_profile=None):
    """
    modifica materiale didattico
    """
    material = get_object_or_404(DocenteMaterialeDidattico,
                                 pk=data_id,
                                 matricola=teacher)
...
@can_manage_teachers
@can_edit_teacher
def teacher_materials_data_new(request, code, my_offices=None, teacher=None,
                               my_teacher_profile=None):
    """
...
@can_manage_teachers
@can_edit_teacher
def teacher_materials_data_delete(request, code, data_id, my_offices=None,
                                  teacher=None, materials=None, other_data=None,
                                  board=None,
                                  my_teacher_profile=None):
    """
