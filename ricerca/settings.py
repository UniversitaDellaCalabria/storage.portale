...
LABEL_MAPPING = {
    'en': {
        ...
        'LaboratoryResearchPersonnel': 'Research Personnel',
        'LaboratoryTechPersonnel': 'Tech Personnel',
        'LaboratoryOfferedServices': 'Offered Services',
        ...
        'PublicationCommunity': 'Community',
        'Publication': 'Publication',
        'PublicationLabel': 'Publication Type',
        'PublicationContributors': 'Contributors',
    ...
    'it': {
        ...
        'LaboratoryServicesScope': 'Finalità Servizi',
        'LaboratoryResearchScope': 'Finalità Ricerca',
        'LaboratoryTeachingScope': 'Finalità Didattica',
        'LaboratoryActivities': 'Attivitià',
        'LaboratoryErc1': 'Erc 1',
        'LaboratoryResearchPersonnel': 'Personale Ricerca',
        ...
        'PublicationContributors': 'Contributori',
        'PublicationAuthors': 'Autori',
