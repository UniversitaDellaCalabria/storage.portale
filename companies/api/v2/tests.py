...
class CompaniesUnitTest(TestCase):
    def setUp(self):
        ...
        s1 = ApiCompaniesUnitTestMethods.create_spinoffStartupDatiBase(area_tecnologica=t1,matricola_referente_unical=p)
        ApiCompaniesUnitTestMethods.create_spinoffStartupDipartimento(spinoff_startup_dati_base=s1,didattica_dipartimento=d1)
