...
from advanced_training.management.forms import MasterDatiGeneraliForm, MasterIscrizioniForm, MasterContenutiForm, MasterStageForm, MasterAltroForm
...
def master_info_edit(request, pk):
    ...
    if request.POST:
        ...
        if form.is_valid():
            ...
            messages.success(request, f"({form_name}) - Dati master aggiornati con successo")
