...
## List
HIGHFORMATION_MASTERS_LIST_SUMMARY = "List of high formation master's courses"
HIGHFORMATION_MASTERS_LIST_DESCRIPTION = (
...
## Retrieve
HIGHFORMATION_MASTERS_RETRIEVE_SUMMARY = "Retrieve a high formation master's course"
HIGHFORMATION_MASTERS_RETRIEVE_DESCRIPTION = (
    "Returns full details of a specific high formation master's course identified by its ID. "
)

# High Formation Course Types
## List
HIGHFORMATION_COURSE_TYPES_LIST_SUMMARY = "List of high formation course types"
HIGHFORMATION_COURSE_TYPES_LIST_DESCRIPTION = (
