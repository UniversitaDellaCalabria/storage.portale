    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                # ('comu_res', models.ForeignKey(db_column='ID_COMU_RES', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="structures.ComuniAll")),
                # ('cd_uo_aff_org', models.ForeignKey(db_column='CD_UO_AFF_ORG', on_delete=django.db.models.deletion.DO_NOTHING, to="structures.UnitaOrganizzativa")),
                ...
                ('cd_csa_aff_org2', models.CharField(blank=True, db_column='CD_CSA_AFF_ORG2', max_length=6, null=True)),
                ...
                ('cd_csa_aff_org3', models.CharField(blank=True, db_column='CD_CSA_AFF_ORG3', max_length=6, null=True)),
                ...
                ('cd_csa_aff_org4', models.CharField(blank=True, db_column='CD_CSA_AFF_ORG4', max_length=6, null=True)),
                ...
                ('urlcv', models.URLField(blank=True, db_column='URLCV', max_length=255, null=True)),
                ...
                ('cv_full_it', models.TextField(blank=True, db_column='CV_FULL_IT', null=True)),
                ('cv_short_it', models.TextField(blank=True, db_column='CV_SHORT_IT', null=True)),
                ('cv_full_eng', models.TextField(blank=True, db_column='CV_FULL_ENG', null=True)),
                ('cv_short_eng', models.TextField(blank=True, db_column='CV_SHORT_ENG', null=True)),
                # ('user_ins', models.ForeignKey(related_name="user_ins_personale", null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                # ('user_mod', models.ForeignKey(related_name="user_mod_personale", null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'PERSONALE',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cd_ruolo', models.CharField(db_column='CD_RUOLO', max_length=50, primary_key=True, serialize=False)),
