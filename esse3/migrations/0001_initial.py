...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('ad_id_esse3', models.IntegerField(db_column='AD_ID_ESSE3', primary_key=True, serialize=False)),
                ('ad_cod', models.CharField(blank=True, db_column='AD_COD', max_length=10, null=True)),
                ('ad_des', models.CharField(blank=True, db_column='AD_DES', max_length=255, null=True)),
                ('tipo_entita', models.IntegerField(blank=True, db_column='TIPO_ENTITA', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('dip_id_esse3', models.IntegerField(blank=True, db_column='DIP_ID_ESSE3', null=True)),
                ...
                ('cds_url_info_web', models.CharField(blank=True, db_column='CDS_URL_INFO_WEB', max_length=2000, null=True)),
