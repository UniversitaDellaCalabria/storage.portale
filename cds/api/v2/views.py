...
class StudyActivitiesViewSet(ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        try:
            ...
            raise NotFound(detail="The requested study activity does not exist.", code=404)
    ...
    def get_serializer_class(self):
        try:
            ...
            raise APIException(detail=f"An unexpected error occurred: {str(e)}", code=500)
    ...
    def get_queryset(self, request, *args, **kwargs):
        if self.action == "list":
            ...
            try: 
                ...
                raise NotFound(detail="The requested morphing history does not exist.", code=404)
            except Exception as e:
                raise APIException(detail=f"An unexpected error occurred: {str(e)}", code=500)
...
class AcademicPathsViewSet(ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        try: 
            ...
            raise NotFound(detail="The requested academic pathway does not exist.", code=404)
        except ValueError as e:
            raise ValidationError(detail=str(e), code=400)
        except PermissionError as e:
            raise PermissionDenied(detail=str(e), code=403)
