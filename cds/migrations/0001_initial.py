# Generated by Django 4.2.20 on 2026-05-19 11:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('structures', '0002_remove_unitaorganizzativafunzioni_id_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_tit_id_ab', models.IntegerField(blank=True, db_column='DOC_TIT_ID_AB', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mod_off_id', models.IntegerField(blank=True, db_column='MOD_OFF_ID', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cla_miur_cod', models.CharField(blank=True, db_column='CLA_MIUR_COD', max_length=20, null=True)),
                ...
                ('intercla_miur_cod', models.CharField(blank=True, db_column='INTERCLA_MIUR_COD', max_length=20, null=True)),
                ...
                ('url', models.URLField(blank=True, db_column='URL', max_length=255, null=True)),
                ('cds_url_info_web', models.URLField(blank=True, db_column='CDS_URL_INFO_WEB', max_length=255, null=True)),
                ...
                ('dip', models.ForeignKey(blank=True, db_column='DIP_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='structures.didatticadipartimento')),
            ],
            options={
                'verbose_name': 'Cds',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('didattica_cds', models.ForeignKey(db_column='ID_DIDATTICA_CDS', on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticacds')),
                ('user_mod', models.ForeignKey(blank=True, db_column='user_mod_id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_id_ab', models.IntegerField(blank=True, db_column='DOC_ID_AB', null=True)),
                ...
                ('erog', models.ForeignKey(blank=True, db_column='EROG_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticaattivitaformativaerogata')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pds_regdid', models.ForeignKey(blank=True, db_column='PDS_REGDID_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticapdsregolamento')),
                ('regpiani', models.ForeignKey(db_column='REGPIANI_ID', on_delete=django.db.models.deletion.DO_NOTHING, related_name='didatticapianosche', to='cds.didatticapianoregolamento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cds', models.ForeignKey(blank=True, db_column='CDS_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticacds')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testo_regdid_url', models.URLField(blank=True, db_column='TESTO_REGDID_URL', max_length=1024, null=True)),
                ...
                ('regdid', models.ForeignKey(db_column='REGDID_ID', on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticaregolamento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_mod', models.DateTimeField(blank=True, db_column='DT_MOD', null=True)),
                ('user_mod', models.ForeignKey(blank=True, db_column='user_mod_id', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clob_txt_eng', models.TextField(blank=True, db_column='CLOB_TXT_ENG', null=True)),
                ('dt_mod', models.DateTimeField(blank=True, db_column='DT_MOD', null=True)),
                ('regdid', models.ForeignKey(db_column='ID_DIDATTICA_REGOLAMENTO', on_delete=django.db.models.deletion.CASCADE, to='cds.didatticaregolamento')),
                ('tipo_testo_regdid_cod', models.ForeignKey(db_column='ID_DIDATTICA_REGOLAMENTO_TIPOLOGIA_ALTRI_DATI', on_delete=django.db.models.deletion.PROTECT, to='cds.didatticaregolamentotipologiaaltridati', to_field='tipo_testo_regdid_cod')),
                ('user_mod', models.ForeignKey(blank=True, db_column='user_mod_id', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pds_regdid', models.ForeignKey(blank=True, db_column='PDS_REGDID_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticapdsregolamento')),
                ('regpiani', models.ForeignKey(blank=True, db_column='REGPIANI_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticapianoregolamento')),
                ('vin', models.ForeignKey(blank=True, db_column='VIN_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticapianosceltavincoli')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sce', models.ForeignKey(blank=True, db_column='SCE_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticapianosceltavincoli')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('af', models.ForeignKey(blank=True, db_column='AF_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticaattivitaformativa')),
                ('amb_id_af', models.ForeignKey(blank=True, db_column='AMB_ID_AF', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticaambiti')),
                ('pds_regdid', models.ForeignKey(blank=True, db_column='PDS_REGDID_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticapdsregolamento')),
                ('sce', models.ForeignKey(blank=True, db_column='SCE_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticapianosceltavincoli')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='regdid',
            field=models.ForeignKey(blank=True, db_column='REGDID_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticaregolamento'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_ins_mod', models.DateField(blank=True, db_column='DT_INS_MOD', null=True)),
                ('coper', models.ForeignKey(db_column='COPER_ID', on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticacopertura')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_mod', models.DateTimeField(blank=True, db_column='DT_MOD', null=True)),
                ('user_mod', models.ForeignKey(db_column='user_mod_id', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cdsord', models.ForeignKey(blank=True, db_column='CDSORD_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='didatticacdslingua', to='cds.didatticacds', to_field='cdsord_id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibile', models.BooleanField(db_column='VISIBILE', default=True)),
                ('dt_mod', models.DateField(db_column='DT_MOD')),
                ('didattica_cds_gruppi', models.ForeignKey(db_column='ID_DIDATTICA_CDS_GRUPPI', on_delete=django.db.models.deletion.CASCADE, to='cds.didatticacdsgruppi')),
                ('matricola', models.ForeignKey(blank=True, db_column='ID_PERSONALE_MATRICOLA', null=True, on_delete=django.db.models.deletion.SET_NULL, to='addressbook.personale', to_field='matricola')),
                ('user_mod', models.ForeignKey(blank=True, db_column='user_mod_id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cds', models.ForeignKey(db_column='ID_DIDATTICA_CDS', on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticacds')),
                ('matricola_riferimento', models.ForeignKey(blank=True, db_column='ID_PERSONALE_MATRICOLA_RIFERIMENTO', null=True, on_delete=django.db.models.deletion.SET_NULL, to='addressbook.personale', to_field='matricola')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cfu', models.DecimalField(blank=True, db_column='CFU', decimal_places=2, max_digits=5, null=True)),
                ('ore', models.DecimalField(blank=True, db_column='ORE', decimal_places=2, max_digits=6, null=True)),
                ('erog_id', models.IntegerField(db_column='EROG_ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_tit_id_ab', models.IntegerField(blank=True, db_column='DOC_TIT_ID_AB', null=True)),
                ('doc_tit_matricola', models.CharField(blank=True, db_column='DOC_TIT_MATRICOLA', max_length=20, null=True)),
                ('doc_resp_mod_id_ab', models.IntegerField(blank=True, db_column='DOC_RESP_MOD_ID_AB', null=True)),
                ...
                ('flag_professionalizzante', models.CharField(blank=True, db_column='FLAG_PROFESSIONALIZZANTE', max_length=255, null=True)),
                ('dt_ins_mod', models.DateField(blank=True, db_column='DT_INS_MOD', null=True)),
                ('af_off', models.ForeignKey(blank=True, db_column='AF_OFF_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticaattivitaformativa')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='id_cds',
            field=models.ForeignKey(blank=True, db_column='ID_CDS', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticacds'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('dt_ins', models.DateTimeField(auto_now_add=True, db_column='DT_INS')),
                ('dt_mod', models.DateTimeField(auto_now=True, db_column='DT_MOD', null=True)),
                ('af', models.ForeignKey(db_column='AF_ID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='didatticaf', serialize=False, to='cds.didatticaattivitaformativa')),
                ('aa_off_id', models.IntegerField(blank=True, db_column='AA_OFF_ID', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matricola_coordinatore', models.ForeignKey(blank=True, db_column='ID_PERSONALE_MATRICOLA_COORDINATORE', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='coordinatore', to='addressbook.personale', to_field='matricola')),
                ('matricola_vice_coordinatore', models.ForeignKey(blank=True, db_column='ID_PERSONALE_MATRICOLA_VICE_COORDINATORE', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='vice_coordinatore', to='addressbook.personale', to_field='matricola')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nota_post', models.TextField(blank=True, db_column='NOTA_POST', null=True)),
                ('nota_post_vis_web_flg', models.IntegerField(blank=True, db_column='NOTA_POST_VIS_WEB_FLG', null=True)),
                ('amb', models.ForeignKey(blank=True, db_column='AMB_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticaambiti')),
                ('sce', models.ForeignKey(db_column='SCE_ID', on_delete=django.db.models.deletion.DO_NOTHING, to='cds.didatticapianosceltavincoli')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cds_prec', models.OneToOneField(db_column='ID_DIDATTICA_CDS_PREC', on_delete=django.db.models.deletion.CASCADE, related_name='cds_collegamento_prec', to='cds.didatticacds')),
            ],
            options={
