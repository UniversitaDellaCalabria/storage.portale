...
CDS_MANIFESTO_MEDIA_PATH_BASE = getattr(settings, "CDS_MANIFESTO_MEDIA_PATH_BASE", "portale/cds/manifesti")
...
CDS_REGOLAMENTO_MEDIA_PATH_BASE = getattr(settings, "CDS_REGOLAMENTO_MEDIA_PATH_BASE", "portale/cds/regolamenti")
def cds_regolamento_media_path(instance, filename):
    return f'{CDS_REGOLAMENTO_MEDIA_PATH_BASE}/{instance.regdid_id.aa_reg_did}/{filename}'

# Path to cds educational order
CDS_ORDINAMENTO_MEDIA_PATH_BASE = getattr(settings, "CDS_ORDINAMENTO_MEDIA_PATH_BASE", "portale/cds/ordinamenti")
def cds_ordinamento_media_path(instance, filename):
    return f'{CDS_ORDINAMENTO_MEDIA_PATH_BASE}/{instance.regdid_id.aa_reg_did}/{filename}'

# Path to cds multimedia
CDS_MULTIMEDIA_MEDIA_PATH_BASE = getattr(settings, "CDS_MULTIMEDIA_MEDIA_PATH_BASE", "portale/cds_media_brochure")
...
CDS_BROCHURE_MEDIA_PATH = getattr(settings, "CDS_BROCHURE_MEDIA_PATH", "portale/cds_media_brochure")
