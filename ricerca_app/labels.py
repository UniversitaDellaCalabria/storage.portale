...
LABEL_MAPPING = {
    'en': {
        ...
        'CDSId': 'Cds Id',
        'CDSCOD': 'Cds Code',
        'CDSAcademicYear': 'Cds Academic Year',
        'CDSName': 'Cds Name',
        'CDSCourseClassName': 'Cds Course Class Name',
        'CDSCourseInterClassDes': 'Cds Course InterClass Des',
        'CDSLanguage': 'Cds Language',
        'CDSDuration': 'Cds Duration',
        'CDSVideo': 'Cds Video',
        'CDSIntro': 'Cds Intro',
        'CDSAdmission': 'Admission',
        'CDSGoals': 'Cds Goals',
        'CDSJobOpportunities': 'Cds Job Opportunities',
        'CDSTaxes': 'Cds Taxes',
        'CDSScholarships': 'Cds Scholarships',
        'CDSConcessions': 'Cds Concessions',
        'CDSShortDescription': 'Cds Short Description',
        'CDSStudyPlan': 'Cds Study Plan',
        'CDSEnrollmentMode': 'Cds Enrollment Mode',
        'CDSUrl': 'Cds Url',
        'CDSUrlStatus': 'Cds Url Status',
        'CDSExStudents': 'Cds Ex Students',
        'CDSLinks': 'Cds Links',
        'CDSSliders': 'Cds Sliders',
        'CDSSeatsNumber': 'Cds Seats Number',
