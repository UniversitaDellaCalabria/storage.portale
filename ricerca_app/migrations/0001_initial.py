    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stato_cdsord_cod', models.CharField(blank=True, db_column='STATO_CDSORD_COD', max_length=5, null=True)),
                ('dip_cod', models.ForeignKey(blank=True, db_column='DIP_COD', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='ricerca_app.didatticadipartimento', to_field='dip_cod')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='ricercaaster1',
            name='user_ins',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_ins_ra1', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='ricercaaster1',
            name='user_mod',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_mod_ra1', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
